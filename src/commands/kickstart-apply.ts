/**
 * FusionAuth CLI Kickstart Apply Command
...
import { HTTPClient, StepExecutor } from './kickstart/http-client.js';
import { logEvent } from '../utils.js';
import * as utils from '../utils.js';

const action = async function (options: Record<string, unknown>): Promise<void> {
  try {
    logEvent('cli command kickstart:apply');
...
/**
 * Kickstart Apply Command
 */
export const kickstartApply = new Command()
  .command('kickstart:apply')
