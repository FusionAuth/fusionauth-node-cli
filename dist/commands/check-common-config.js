...
const action = function (_a) {
    return __awaiter(this, arguments, void 0, function* ({ key: apiKey, host, skipLicenseCheck }) {
        var _b, _c;
        ...
        try {
            ...
            try {
                ...
                else if (!((_b = createUserResponse.response.user) === null || _b === void 0 ? void 0 : _b.id)) {
                    results.push({
                        passed: false,
            ...
            try {
                ...
                if (!tenantResponse.wasSuccessful()) {
                    ...
                    for (const tenant of tenants) {
                        const emailHost = (_c = tenant.emailConfiguration) === null || _c === void 0 ? void 0 : _c.host;
